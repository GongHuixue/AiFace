...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "yT3Y9y3jXx7jWI5U6q5ZkHKO";
    public static String secretKey = "Bj0u9WVW7bVePdqdAslAjd3Ux00X2cW9";
    public static String licenseID = "AiFaceLicense-face-android";
